...
# ===================== PAGE CONFIG =====================
st.set_page_config(page_title="iPa Result Analyzer v7.3", layout="wide", initial_sidebar_state="expanded")
...
# ======================== ULTIMATE SPACE INJECTOR ========================
def clean_glued_name(name):
    """Inserts spaces into glued names like 'NAGMANAAZ' -> 'NAGMA NAAZ'"""
    if not name:
        return name
    ...
    # ULTIMATE TOKEN LIST: Includes every possible prefix/suffix in your data
    tokens = [
        # Major prefixes/suffixes from your examples
        'MOHAMMED', 'MOHD', 'ABDUL', 'SHAIKH', 'SYED', 'QUTUBUDDIN', 
        'MOHAMMAD', 'MOHAMED', 'SHAIK', 'ABDULLAH', 'NAEEM', 'AHMAD', 
        'JAVED', 'NAGMA', 'NAAZ', 'SHAFI', 'ASRAR', 'MEER', 'YOUSUF', 
        'HAROON', 'RAHMAN', 'WAHAB', 'FARID', 'ABBAS', 'SALMAN', 
        'AKHTAR', 'ANJUM', 'SABIR', 'DANISH', 'JUNAID', 'SIMRAN', 
        'PARWEEN', 'KAUSAR', 'ABUZAR', 'MAQDOOM', 'IFTIKHAR', 
        'ZAMEER', 'ALAM', 'TABBASUM', 'PERVEEN', 'RAZA', 'HUSSAIN', 
        'NOMAN', 'ARIF', 'FAIZ', 'MEHAR', 'NISAR', 'SHAMS', 'AFTAB', 
        'SAFWAN', 'TAUQEER', 'SAQIB', 'BANO', 'MUGERA', 'ADNAN', 
        'KAMAL', 'AHMED', 'ASIF', 'ANWER', 'SIDDIQUI', 'FARAZ', 
        'KASHIF', 'NASEEM', 'RIZWAN', 'EHTASHAM', 'ISHFAQ', 
        'MAQBOOL', 'NAYYAR', 'SOHAIL', 'TANVEER', 'ZAHID', 'SHAHID', 
        'SHAKIR', 'MOID', 'AHMAD', 'ALI', 'KHAN', 'BIN', 'MD', 
        'HASAN', 'ABD', 'RAHMAT', 'HADI', 'UL', 'WARA', 'BEGUM', 
        'FATIMA', 'ZEESHAN', 'FURQAN', 'TARIQUE', 'ANWAR', 'KAHKASHA', 
        'MUSTAFA', 'SAFA', 'QAISAR', 'UNNISA', 'AMEEN', 'AZEEM', 
        'QUANITA', 'AMANI', 'SAFI', 'UJALA', 'KUMAR', 'ANEES', 
        'SAGAR', 'NAZISH', 'SOFIA', 'ZAINAB', 'MARYAM', 'NASEER'
    ]
...
def generate_pdf(df):
    ...
    pdf.cell(200, 10, txt="Generated by iPa v7.3 | For Moid", ln=True, align='C')
...
if uploaded_file is not None:
    ...
    with st.spinner("🔄 iPa v7.3 analyzing..."):
        try:
...
st.markdown("---")
st.markdown("<p style='text-align: center; color: #64748b;'>Built with ❤️ by iPa v7.3 | Ultimate Space Injector</p>", unsafe_allow_html=True)
